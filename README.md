...
- **Auditar detecciones** marcándolas como verificadas o falsos positivos directamente desde la interfaz. Las cuales se envian luego a un 'bucket' en MinIO para poder re-entrenar el modelo.

- **Consultar y generar reportes de IA** por video procesado o global, en tiempo real desde Ollama.

- **Chatear con PozoBot**, el asistente de inteligencia vial que responde preguntas sobre detecciones a nivel municipal (global) o por video específico.

- **Monitorear el estado de la infraestructura** desde una página de health status dedicada con uptime visual por servicio.
